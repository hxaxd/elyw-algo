...
@Log(title='职责管理', business_type=BusinessType.INSERT)
...
@Log(title='职责管理', business_type=BusinessType.UPDATE)
...
@Log(title='职责管理', business_type=BusinessType.DELETE)
...
@Log(title='职责管理', business_type=BusinessType.EXPORT)
