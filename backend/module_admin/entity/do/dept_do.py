...
class SysDept(Base):
    ...
    dept_id = Column(Integer, primary_key=True, autoincrement=True, comment='小组id')
    parent_id = Column(Integer, default=0, comment='父小组id')
    ancestors = Column(String(50), nullable=True, default='', comment='祖级列表')
    dept_name = Column(String(30), nullable=True, default='', comment='小组名称')
    ...
    status = Column(String(1), nullable=True, default='0', comment='小组状态（0正常 1停用）')
