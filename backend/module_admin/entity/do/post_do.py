...
class SysPost(Base):
    ...
    post_id = Column(Integer, primary_key=True, autoincrement=True, comment='职责ID')
    post_code = Column(String(64), nullable=False, comment='职责编码')
    post_name = Column(String(50), nullable=False, comment='职责名称')
