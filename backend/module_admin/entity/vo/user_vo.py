...
class UserModel(BaseModel):
    ...
    dept_id: Optional[int] = Field(default=None, description='小组ID')
...
class UserPostModel(BaseModel):
    """
    用户与职责关联表对应pydantic模型
    """

    model_config = ConfigDict(alias_generator=to_camel, from_attributes=True)

    user_id: Optional[int] = Field(default=None, description='用户ID')
    post_id: Optional[int] = Field(default=None, description='职责ID')


class UserInfoModel(UserModel):
    post_ids: Optional[Union[str, None]] = Field(default=None, description='职责ID信息')
    role_ids: Optional[Union[str, None]] = Field(default=None, description='角色ID信息')
    dept: Optional[Union[DeptModel, None]] = Field(default=None, description='小组信息')
...
class UserDetailModel(BaseModel):
    ...
    post_ids: Optional[List] = Field(default=None, description='职责ID信息')
    posts: List[Union[PostModel, None]] = Field(description='职责信息')
...
class UserProfileModel(BaseModel):
    ...
    post_group: Union[str, None] = Field(description='职责信息')
...
class AddUserModel(UserModel):
    ...
    post_ids: Optional[List] = Field(default=[], description='职责ID信息')
